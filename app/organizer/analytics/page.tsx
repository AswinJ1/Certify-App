...
export default function OrganizerAnalyticsPage() {
  ...
  if (!data || data.summary === undefined) {
    return (
      <div className="materio-card p-12 text-center bg-white border border-[#dbdade]">
        ...
        <p className="text-xs text-[#6f6b7d] mt-1">Publish certificate portals and share them with participants to see real-time statistics.</p>
      </div>
    );
  }
  ...
  const statCards = [
    ...
    { label: 'Configured Certs', value: summary.totalCertificates, icon: Award, color: 'text-[#28c76f]', bg: 'bg-[#28c76f]/10' },
    { label: 'Live Portals', value: summary.publishedCertificates, icon: TrendingUp, color: 'text-[#ff9f43]', bg: 'bg-[#ff9f43]/10' },
    { label: 'Total Events', value: summary.totalEvents, icon: Calendar, color: 'text-[#7367f0]', bg: 'bg-[#7367f0]/10' },
  ];
